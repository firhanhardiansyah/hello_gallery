...
void main() {
  testWidgets(
    '_VideoPlaybackButton visibility hides faster than overall controls',
    (tester) async {
      ...
      AnimatedOpacity animatedOpacity = tester.widget(
        find
            .ancestor(of: buttonFinder, matching: find.byType(AnimatedOpacity))
            .first,
      );
