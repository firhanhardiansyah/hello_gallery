...
mixin _$SettingsUiState {
 ...
 SettingsLoadState get loadState; AppAppearanceMode get appearanceMode; AppColorTheme get colorTheme; bool get showItemNames;
...
@useResult
$Res call({
 SettingsLoadState loadState, AppAppearanceMode appearanceMode, AppColorTheme colorTheme, bool showItemNames
});
...
/// Create a copy of SettingsUiState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? loadState = null,Object? appearanceMode = null,Object? colorTheme = null,Object? showItemNames = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SettingsLoadState loadState,  AppAppearanceMode appearanceMode,  AppColorTheme colorTheme,  bool showItemNames)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingsUiState() when $default != null:
return $default(_that.loadState,_that.appearanceMode,_that.colorTheme,_that.showItemNames);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SettingsLoadState loadState,  AppAppearanceMode appearanceMode,  AppColorTheme colorTheme,  bool showItemNames)  $default,) {final _that = this;
switch (_that) {
case _SettingsUiState():
return $default(_that.loadState,_that.appearanceMode,_that.colorTheme,_that.showItemNames);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SettingsLoadState loadState,  AppAppearanceMode appearanceMode,  AppColorTheme colorTheme,  bool showItemNames)?  $default,) {final _that = this;
switch (_that) {
case _SettingsUiState() when $default != null:
return $default(_that.loadState,_that.appearanceMode,_that.colorTheme,_that.showItemNames);case _:
  return null;
...
class _SettingsUiState extends SettingsUiState {
  const _SettingsUiState({this.loadState = const SettingsLoadState.loading(), this.appearanceMode = AppAppearanceMode.system, this.colorTheme = AppColorTheme.indigo, this.showItemNames = true}): super._();
...
/// Create a copy of SettingsUiState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? loadState = null,Object? appearanceMode = null,Object? colorTheme = null,Object? showItemNames = null,}) {
